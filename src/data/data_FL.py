...
class SkinData:
    ...
    def get_client_image_ids_20L_80U(self, client_id):
    ...
    def get_client_image_ids_80L_20U(self, client_id):
        labeled, unlabeled, validation = [], [], []
        # 100 val, 2000 training = 2100
        start_idx = 2100 * client_id
        # Pick first 100 as validation
    ...
    def load_clients_ssl(self, client_id):
        ...
        idx_l, idx_u, idx_v = self.get_client_image_ids_20L_80U(client_id)
